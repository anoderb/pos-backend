...
export const stockAdjustmentService = {
  ...
  async buatAdjustment(toko_id, created_by_id, { produk_id, tipe, qty, alasan }) {
    ...
    // Validasi: stok tidak boleh minus — kurangi tidak boleh melebihi stok tersedia
    if (tipe === 'kurang' && qtyNum > stok_sebelum) {
      throw new Error(`Stok tidak mencukupi. Tersedia: ${stok_sebelum}, diminta kurangi: ${qtyNum}`);
    }
