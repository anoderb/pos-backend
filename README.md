# 🚀 Tokiva POS Backend REST API Engine

**Kasir Cerdas untuk UMKM Modern (tokiva.biz.id)**

Dokumentasi REST API Server berbasis Fastify Node.js + Supabase PostgreSQL untuk mengelola seluruh ekosistem Tokiva POS.
...
- **API Base URL Production:** `https://api.tokiva.biz.id/api`
- **File Dokumentasi Utama (Markdown):** [03-API-Endpoints.md](../Dokumentasi/POS/03-API-Endpoints.md)
